...
export const schemas = {
  ...
  updateMatch: Joi.object({
    ...
    start_time: Joi.date().iso().allow(null),
    metadata: Joi.object(),
    stream_url: Joi.string().uri().allow("").allow(null),
    stream_url_fhd: Joi.string().allow("").allow(null),
    stream_url_hd: Joi.string().allow("").allow(null),
    stream_url_sd: Joi.string().allow("").allow(null),
    stream_iptv_fhd: Joi.string().allow("").allow(null),
    stream_iptv_hd: Joi.string().allow("").allow(null),
    stream_iptv_sd: Joi.string().allow("").allow(null),
    home_score: Joi.number().integer().allow(null),
    away_score: Joi.number().integer().allow(null),
  }),
};
