...
export const koooraApi = {
  standings: (competitionId) => api.get("/kooora/standings", { params: { competitionId } }).then((r) => r.data),
  topScorers: (competitionId) => api.get("/kooora/top-scorers", { params: { competitionId } }).then((r) => r.data),
};
